...
Folder **/src** contains source code for creating dataset and performing appropriate classification tasks on it.

Folder **/Classification** contains images that came from classification tasks.

Folder **/ConfusionMatrix** contains appropriate confusion matrix for tested models in .csv and .npz format
